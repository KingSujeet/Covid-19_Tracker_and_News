...
public class NewsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Covid-19 Related News");
    ...
    private void fetchData() {
        ...
        String url = "http://newsapi.org/v2/top-headlines?country=in&category=health&apiKey=a7e8ae26e3514dc491a436ed660680b7";
